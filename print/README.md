...
![alt text]('https://github.com/DaisukeMiyazaki/Kiyosumi/blob/main/print/statics/imgs/casset_pedi_stulle.png')
...
![alt text]('https://github.com/DaisukeMiyazaki/Kiyosumi/blob/main/print/statics/imgs/special_process.png')
2. Then enter your document name, user name and passcode. (for example, hoge/hoge/1111)
![alt text]('https://github.com/DaisukeMiyazaki/Kiyosumi/blob/main/print/statics/imgs/secure_print.png')
3. Press print.
